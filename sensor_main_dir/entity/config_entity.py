...
import os
from sensor_main_dir.constant_var import training_pipeline
from sensor_main_dir.constant_var import training_pipeline
...
class ModelPusherConfig:
    def __init__(self, training_pipeline_config=TrainingPipelineConfig()):
        self.model_evaluation_dir = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.MODEL_PUSHER_DIR_NAME)
